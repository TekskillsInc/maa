                ...
                <div class="col-md-12 col-sm-12 col-xs-12" id="assetMblVersn">
                    <div class="card" id="responseCard">
                       <div class="card-header">
                            <div class="row">
                                <div class="col-8">
                                    <strong class="card-title"><a type="button" href="notification?prtyid=${prptyid}&prptyName=${prptyName}" class="btn btn-info btn-sm" style="color: #fff"><i class="fa fa-arrow-left"></i></a>&nbsp; Add Notification</strong>
                                </div>
                            </div>
                        </div> 
                        <div class="card-body">
                        <form action="saveNotification" method="POST" onsubmit="return checkForm(this);">
                                       ...
                                       <!--  <div class="card-header"><strong>Notification Details</strong></div> -->
                                        <div class="card-body card-block">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="title" name="title" pattern="^[ A-Za-z0-9_@./#&,-]*$" minlength="2" maxlength="75"  class="form-control" required>
											...
											<textarea id="notdescription" name="description" data-rule-required='true'
...
function editNotification(id){
    ...
    {
      var cmt_len = CKEDITOR.instances['notdescription'].getData().replace(/<[^>]*>/gi, '').length;
      if(cmt_len==0) {
