				...
				<div class="col-md-12 col-sm-12 col-xs-12" id="assetMblVersn">
					<div class="card" id="responseCard">
						<div class="card-header">
							<div class="row">
								<div class="col-9">
									<strong class="card-title"><a type="button" href="propertyclassifides?prtyid=${prtyid}&&prptyName=${prptyName}" class="btn btn-info btn-sm" ><i class="fa fa-arrow-left"></i></a>&nbsp;&nbsp;Classifides - Add</strong>
								</div>
								<!-- <div class="col">
						...
						<div class="card-body">							
							<div class="row">
								<div class="col">
									...
									<div class="container">
     		   						<br/>	
									 <form action="/" id="formAddCSF" method="POST" enctype="multipart/form-data">
										<div id="smartwizard">
							<input type="hidden" value="${classifiedid}"  name="id">	
							<input type="hidden" value="${prtyid}"  name="prty_id">
							<input type="hidden" value="${prptyName}"  name="prty_Name">
													<ul>
														<li><a href="#step-1"><br />
																		...
																		<div class="form-group">
																			...
																			<label class="btn btn-outline-info ">
																				...
																				<label class="btn btn-outline-info " id="bedsLabel">
																					<input type="radio" name="noofBeds" id="noofBeds" value="1"  required> 1
																				</label>
																				<label class="btn btn-outline-info" id="bedsLabel">
                                                    ...
                                                    if(!$(this).hasClass('disabled')){
                                                        ...
                                                        if(elmForm){
                                                            ...
                                                            if(elmErr && elmErr.length > 0){
                                                               ...
                                                               /*  jQuery.each(jQuery('#showImage')[0].files, function(i, file) {
																...
																//$('#formAddCSF').submit();
                                                     	            	/*  	alert("image file form data---"+form.inputfield.value); */
                                                     	            	 $.ajax({
...
if(stepNumber==1){
	...
	$(document).ready(function(){
		...
		if(type=='cs'){
			 ...
			 var jsonString=escapeSpecialChars('${viewObject}')
		...
		if(csftype=='Rent'){
			/* ,#noofbaths,#nofofparking,#noofBeds,#areaSqft,#facing */
			$("#csfPrtytype,#prtyAddress,#city,#state,#prtyavialbleon,#advance,#r_amount,#prtyavialbleon,#csfTitle,#csfDesription,#r_amount,#advance").attr("required", true);
			...
			$("#name,#email,#phone").attr("required", true);
			/* ,#noofbaths,#nofofparking,#noofBeds,#areaSqft,#facing */
			$("#csfPrtytype,#prtyAddress,#city,#state,#prtyavialbleon,#advance,#r_amount,#prtyavialbleon,#csfTitle,#csfDesription,#s_amount,#loanFacility").attr("required", true);
			...
			$('.sw-btn-next').hide();
			/* ,#noofbaths,#nofofparking,#noofBeds,#areaSqft,#facing */
			$("#csfPrtytype,#prtyAddress,#city,#prtyavialbleon,#advance,#r_amount,#name,#email,#phone,#prtyavialbleon,#csfTitle,#csfDesription,#r_amount,#advance,#s_amount,#loanFacility,#showImage").attr("required", false);
